...
@interface ScreenCaptureView : GMSMapView<GMSMapViewDelegate> {
	//video writing
...
@property(nonatomic, assign) id<GMSMapViewDelegate> delegate;
@property(nonatomic, assign) id<ScreenCaptureViewDelegate> capt_delegate;
